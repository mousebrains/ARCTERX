#! /usr/bin/env python3
#
# Install a service for the MODIS fetcher
#
...
parser.add_argument("--service", type=str, default="MODIS.service", help="Service file")
parser.add_argument("--timer", type=str, default="MODIS.timer", help="Timer file")
