...
parser.add_argument("--service", type=str, default="UW_justin.service", help="Service file")
parser.add_argument("--timer", type=str, default="UW_justin.timer", help="Timer file")
