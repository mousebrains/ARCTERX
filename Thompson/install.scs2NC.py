#! /usr/bin/env python3
#
# Install a service for extracting data from SCS files
#
...
parser.add_argument("--service", type=str, default="scs2NC.service", help="Service file")
parser.add_argument("--timer", type=str, default="scs2NC.timer", help="Timer file")
