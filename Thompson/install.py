#! /usr/bin/env python3
#
# Install a service for monitoring the Thompson's udp datagrams
#
...
parser.add_argument("--service", type=str, default="udpProcess.service", help="Service file")
parser.add_argument("--serviceDirectory", type=str, default="/etc/systemd/system",
        help="Where to copy service files to")
