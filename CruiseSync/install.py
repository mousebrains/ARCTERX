...
parser.add_argument("--service", type=str, default="METcompress.service", help="Service file")
parser.add_argument("--timer", type=str, default="METcompress.timer", help="Timer file")
